            ...
            options: {
                lessLoaderOptions: {
                    lessOptions: {
                        ...
                        modifyVars: {
                            '@primary-color': 'rgb(15, 154, 83)', // primary color for all components
                            ...
                            '@table-header-bg': 'rgb(75, 84, 92)',
                            '@table-header-color': 'white', // thead table bg
                            '@table-header-sort-bg': '#86c6fbd9',
                            '@table-body-sort-bg': '#fafafa',
                            '@table-row-hover-bg': '#3b7ddd24',
                            '@input-disabled-color': 'black',
                            // @table-selected-row-color: inherit;
                            // @table-selected-row-bg: @primary-1;
                            // @table-body-selected-sort-bg: @table-selected-row-bg;
                            '@table-selected-row-hover-bg': '#3b7ddd24',
