...
export function getBetweenDate(date1, date2) {
    ...
    var hari = diffDuration.days() ? diffDuration.days() + " Hari " : "" 
    var jam = diffDuration.hours() ? diffDuration.hours() + " Jam " : ""
    var menit = diffDuration.minutes() ? diffDuration.minutes() + " Menit " : ""
